...
const entries = [
  {
    ...
    body: "started playing gta vice city, rise of nation, age of empires, call of duty, need for speed most wanted etc",
    tag: "origin",
  },
  {
    year: "2024",
    title: "The detour through physics",
    body: "I tried to study the universe and ended up modeling it in Code Editor. The professors called it cheating. I called it a portal.",
    tag: "detour",
  },
  {
    year: "2025.2",
    title: "First real users, first real bugs",
    body: "Contributed to an live broadcasting platform. Eleven humans used it on a Tuesday. I&rsquo;ve been chasing that feeling ever since.",
    tag: "shipping",
  },
  {
    year: "2025.5",
  ...
  {
    year: "2026",
    title: "Local-first, slow-web, hand-rolled (Own Company) ",
    body: "Got tired of cloud-shaped problems. Started writing software with homies that belongs to the person holding the device. Felt like coming home.",
    tag: "now",
  },
];
